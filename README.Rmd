...
The package supports two workflows. The recommended approach is to use `create_schema_db()` to download the schema tables and save them to an SQLite database:
